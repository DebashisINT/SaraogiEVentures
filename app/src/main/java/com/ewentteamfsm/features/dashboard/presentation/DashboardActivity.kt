package com.ewentteamfsm.features.dashboard.presentation
...
import com.ewentteamfsm.*
import com.ewentteamfsm.R
import com.ewentteamfsm.app.*
import com.ewentteamfsm.app.NewFileUtils.browseDocuments
import com.ewentteamfsm.app.NewFileUtils.browsePDFDocuments
import com.ewentteamfsm.app.NewFileUtils.getExtension
import com.ewentteamfsm.app.domain.*
import com.ewentteamfsm.app.types.DashboardType
import com.ewentteamfsm.app.types.FragType
import com.ewentteamfsm.app.types.TopBarConfig
import com.ewentteamfsm.app.uiaction.DisplayAlert
import com.ewentteamfsm.app.utils.*
import com.ewentteamfsm.app.utils.AppUtils.Companion.isProfile
import com.ewentteamfsm.base.BaseResponse
import com.ewentteamfsm.base.presentation.BaseActivity
import com.ewentteamfsm.base.presentation.BaseFragment
import com.ewentteamfsm.features.NewQuotation.*
import com.ewentteamfsm.features.NewQuotation.api.GetQuotRegProvider
import com.ewentteamfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.ewentteamfsm.features.SearchLocation.SearchLocationFragment
import com.ewentteamfsm.features.SearchLocation.locationInfoModel
import com.ewentteamfsm.features.TA.ViewAllTAListFragment
import com.ewentteamfsm.features.achievement.AchievementFragment
import com.ewentteamfsm.features.activities.presentation.*
import com.ewentteamfsm.features.addAttendence.*
import com.ewentteamfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.ewentteamfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.ewentteamfsm.features.addAttendence.model.GetReportToFCMResponse
import com.ewentteamfsm.features.addAttendence.model.GetReportToResponse
import com.ewentteamfsm.features.addAttendence.model.Leave_list_Response
import com.ewentteamfsm.features.addorder.presentation.AddOrderFragment
...
import com.ewentteamfsm.features.addshop.presentation.AddShopFragment
import com.ewentteamfsm.features.addshop.presentation.OTPVerificationDialog
import com.ewentteamfsm.features.addshop.presentation.ScanImageFragment
import com.ewentteamfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.ewentteamfsm.features.alarm.model.AlarmData
import com.ewentteamfsm.features.alarm.presetation.AttendanceReportFragment
import com.ewentteamfsm.features.alarm.presetation.PerformanceReportFragment
import com.ewentteamfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.ewentteamfsm.features.alarm.presetation.VisitReportFragment
import com.ewentteamfsm.features.attendance.AttendanceFragment
import com.ewentteamfsm.features.attendance.api.AttendanceRepositoryProvider
import com.ewentteamfsm.features.attendance.model.AttendanceRequest
import com.ewentteamfsm.features.attendance.model.AttendanceResponse
import com.ewentteamfsm.features.averageshop.presentation.AverageShopFragment
import com.ewentteamfsm.features.avgorder.presentation.AverageOrderFragment
import com.ewentteamfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.ewentteamfsm.features.beatCustom.TeamBeatListFragment
import com.ewentteamfsm.features.billing.presentation.AddBillingFragment
import com.ewentteamfsm.features.billing.presentation.BillingDetailsFragment
import com.ewentteamfsm.features.billing.presentation.BillingListFragment
import com.ewentteamfsm.features.changepassword.presentation.ChangePasswordDialog
import com.ewentteamfsm.features.chat.model.ChatListDataModel
import com.ewentteamfsm.features.chat.model.ChatUserDataModel
import com.ewentteamfsm.features.chat.model.GroupUserDataModel
import com.ewentteamfsm.features.chat.presentation.*
import com.ewentteamfsm.features.chatbot.presentation.ChatBotFragment
import com.ewentteamfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.ewentteamfsm.features.chatbot.presentation.ReportsFragment
import com.ewentteamfsm.features.chatbot.presentation.SelectLanguageDialog
import com.ewentteamfsm.features.commondialog.presentation.CommonDialog
import com.ewentteamfsm.features.commondialog.presentation.CommonDialogClickListener
import com.ewentteamfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.ewentteamfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.ewentteamfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.ewentteamfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.ewentteamfsm.features.contacts.ContactDtls
import com.ewentteamfsm.features.contacts.ContactGr
import com.ewentteamfsm.features.contacts.ContactMasterRes
import com.ewentteamfsm.features.contacts.ContactsAddFrag
import com.ewentteamfsm.features.contacts.ContactsFrag
import com.ewentteamfsm.features.contacts.TypeMasterRes
import com.ewentteamfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.ewentteamfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.ewentteamfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.ewentteamfsm.features.damageProduct.ShopDamageProductListFrag
import com.ewentteamfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.ewentteamfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.ewentteamfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.ewentteamfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.ewentteamfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.ewentteamfsm.features.device_info.presentation.DeviceInfoListFragment
import com.ewentteamfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.ewentteamfsm.features.document.DocumentRepoFeatureNewFragment
import com.ewentteamfsm.features.document.presentation.DocumentListFragment
import com.ewentteamfsm.features.document.presentation.DocumentTypeListFragment
import com.ewentteamfsm.features.document.presentation.OpenFileWebViewFragment
import com.ewentteamfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.ewentteamfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.ewentteamfsm.features.dymanicSection.presentation.DynamicListFragment
import com.ewentteamfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.ewentteamfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.ewentteamfsm.features.home.presentation.HomeFragment
import com.ewentteamfsm.features.homelocation.presentation.HomeLocationFragment
import com.ewentteamfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.ewentteamfsm.features.know_your_state.KnowYourStateFragment
import com.ewentteamfsm.features.lead.LeadFrag
import com.ewentteamfsm.features.lead.ViewLeadFrag
import com.ewentteamfsm.features.leaveapplynew.LeaveHome
import com.ewentteamfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.ewentteamfsm.features.localshops.LocalShopListFragment
import com.ewentteamfsm.features.localshops.LocalShopListMapFragment
import com.ewentteamfsm.features.localshops.NearByShopsMapFragment
import com.ewentteamfsm.features.location.*
import com.ewentteamfsm.features.location.api.LocationRepoProvider
import com.ewentteamfsm.features.location.model.*
import com.ewentteamfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.ewentteamfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.ewentteamfsm.features.login.ShopFeedbackEntity
import com.ewentteamfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.ewentteamfsm.features.login.presentation.LoginActivity
import com.ewentteamfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.ewentteamfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.ewentteamfsm.features.marketAssist.MarketAssistTabFrag
import com.ewentteamfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.ewentteamfsm.features.marketAssist.ShopListMarketAssistFrag
import com.ewentteamfsm.features.marketing.presentation.MarketingPagerFragment
import com.ewentteamfsm.features.meetinglist.prsentation.MeetingListFragment
import com.ewentteamfsm.features.member.MapViewForTeamFrag
import com.ewentteamfsm.features.member.model.TeamLocDataModel
import com.ewentteamfsm.features.member.model.TeamShopListDataModel
import com.ewentteamfsm.features.member.presentation.*
import com.ewentteamfsm.features.menuBeat.MenuBeatFrag
import com.ewentteamfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.ewentteamfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.ewentteamfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.ewentteamfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.ewentteamfsm.features.myjobs.model.CustomerDataModel
import com.ewentteamfsm.features.myjobs.presentation.*
import com.ewentteamfsm.features.myorder.presentation.MyOrderListFragment
import com.ewentteamfsm.features.myprofile.presentation.MyProfileFragment
import com.ewentteamfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.ewentteamfsm.features.nearbyshops.model.ShopData
import com.ewentteamfsm.features.nearbyshops.model.ShopListResponse
import com.ewentteamfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.ewentteamfsm.features.nearbyshops.presentation.BeatListFragment
import com.ewentteamfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.ewentteamfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.ewentteamfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.ewentteamfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.ewentteamfsm.features.newcollection.CollectionDetailsStatusFragment
import com.ewentteamfsm.features.newcollection.CollectionShopListFragment
import com.ewentteamfsm.features.newcollection.NewCollectionListFragment
import com.ewentteamfsm.features.newcollectionreport.*
import com.ewentteamfsm.features.notification.NotificationFragment
import com.ewentteamfsm.features.orderList.NewDateWiseOrderListFragment
import com.ewentteamfsm.features.orderList.NewOrderListFragment
import com.ewentteamfsm.features.orderList.OrderListFragment
import com.ewentteamfsm.features.orderdetail.presentation.OrderDetailFragment
import com.ewentteamfsm.features.orderhistory.ActivityMapFragment
import com.ewentteamfsm.features.orderhistory.OrderhistoryFragment
import com.ewentteamfsm.features.orderhistory.TimeLineFragment
import com.ewentteamfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.ewentteamfsm.features.orderhistory.model.FetchLocationRequest
import com.ewentteamfsm.features.orderhistory.model.FetchLocationResponse
import com.ewentteamfsm.features.orderhistory.model.LocationData
import com.ewentteamfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.ewentteamfsm.features.performance.GpsStatusFragment
import com.ewentteamfsm.features.performance.PerformanceFragment
import com.ewentteamfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.ewentteamfsm.features.performance.model.UpdateGpsInputParamsModel
import com.ewentteamfsm.features.performanceAPP.OwnPerformanceFragment
import com.ewentteamfsm.features.performanceAPP.PerformanceAppFragment
import com.ewentteamfsm.features.performanceAPP.allPerformanceFrag
import com.ewentteamfsm.features.permissionList.ViewPermissionFragment
import com.ewentteamfsm.features.photoReg.*
import com.ewentteamfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.ewentteamfsm.features.quotation.presentation.*
import com.ewentteamfsm.features.reimbursement.presentation.*
import com.ewentteamfsm.features.report.presentation.*
import com.ewentteamfsm.features.returnsOrder.*
import com.ewentteamfsm.features.settings.presentation.SettingsFragment
import com.ewentteamfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.ewentteamfsm.features.shopdetail.presentation.*
import com.ewentteamfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.ewentteamfsm.features.stock.StockDetailsFragment
import com.ewentteamfsm.features.stock.StockListFragment
import com.ewentteamfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.ewentteamfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.ewentteamfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.ewentteamfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.ewentteamfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.ewentteamfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.ewentteamfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.ewentteamfsm.features.survey.SurveyFrag
import com.ewentteamfsm.features.survey.SurveyViewDtlsFrag
import com.ewentteamfsm.features.survey.SurveyViewFrag
import com.ewentteamfsm.features.task.presentation.AddTaskFragment
import com.ewentteamfsm.features.task.presentation.CalenderTaskFragment
import com.ewentteamfsm.features.task.presentation.EditTaskFragment
import com.ewentteamfsm.features.task.presentation.TaskListFragment
import com.ewentteamfsm.features.taskManagement.TaskManagementFrag
import com.ewentteamfsm.features.taskManagement.ViewTaskManagementFrag
import com.ewentteamfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.ewentteamfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.ewentteamfsm.features.timesheet.presentation.TimeSheetListFragment
import com.ewentteamfsm.features.viewAllOrder.CartFragment
import com.ewentteamfsm.features.viewAllOrder.OrderTypeListFragment
import com.ewentteamfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.ewentteamfsm.features.viewAllOrder.ViewCartFragment
import com.ewentteamfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.ewentteamfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.ewentteamfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.ewentteamfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.ewentteamfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.ewentteamfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.ewentteamfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.ewentteamfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.ewentteamfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.ewentteamfsm.features.viewPPDDStock.ViewStockFragment
import com.ewentteamfsm.features.weather.presentation.WeatherFragment
import com.ewentteamfsm.mappackage.MapActivity
import com.ewentteamfsm.mappackage.MapActivityWithoutPath
import com.ewentteamfsm.mappackage.SendBrod
import com.ewentteamfsm.widgets.AppCustomEditText
import com.ewentteamfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xewentteamfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.ewentteamfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
