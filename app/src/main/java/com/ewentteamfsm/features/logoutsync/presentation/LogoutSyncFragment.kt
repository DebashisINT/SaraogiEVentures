package com.ewentteamfsm.features.logoutsync.presentation
...
import com.ewentteamfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.ewentteamfsm.features.billing.api.AddBillingRepoProvider
import com.ewentteamfsm.features.billing.model.AddBillingInputParamsModel
...
import com.ewentteamfsm.features.dashboard.presentation.ReasonDialog
...
import com.ewentteamfsm.features.document.model.AddEditDocumentInputParams
import com.ewentteamfsm.features.document.model.DocumentAttachmentModel
...
import com.ewentteamfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.ewentteamfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.ewentteamfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.ewentteamfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.ewentteamfsm.features.orderhistory.model.*
...
import com.ewentteamfsm.features.quotation.model.AddQuotInputModel
import com.ewentteamfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.ewentteamfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.ewentteamfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.ewentteamfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.ewentteamfsm.features.timesheet.model.AddTimeSheetInputModel
import com.ewentteamfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.ewentteamfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.ewentteamfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.ewentteamfsm.mappackage.SendBrod
import com.ewentteamfsm.widgets.AppCustomTextView
import com.ewentteamfsm.MonitorService
import com.ewentteamfsm.MySingleton
...
import com.ewentteamfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.ewentteamfsm.features.login.model.GetConcurrentUserResponse
import com.ewentteamfsm.features.login.model.WhatsappApiData
import com.ewentteamfsm.features.performance.model.Gps_status_list
import com.ewentteamfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.ewentteamfsm.features.returnsOrder.ReturnProductList
import com.ewentteamfsm.features.returnsOrder.ReturnRequest
import com.ewentteamfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xewentteamfsmlogsample/log.zip").path);
